...
export const Route = createFileRoute("/contactanos")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "Agenda una cita o ponte en contacto con nuestro equipo de salud mental.",
      },
...
function Contactanos() {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      const { name, email, phone, interest } = z
        .object({
          name: z
            .string()
          ...
          <div>
            ...
            <div className="mt-6 space-y-4">
              {channels.map((c) => (
                <div
                  key={c.label}
                  className="card-neon-hover flex items-center gap-4 rounded-2xl glass-card p-5 transition-transform hover:scale-[1.01] hover:shadow-lg"
                >
