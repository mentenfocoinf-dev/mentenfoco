...
- **Hallazgo:** No existe un endpoint para el webhook de Stripe en el código actual (ej. falta una _Supabase Edge Function_ o ruta de API del lado del servidor).
