// Idéntico a src/lib/psychometricScales.ts de la web — contenido clínico literal, no traducir
// ni adaptar (son instrumentos validados: PHQ-9 y GAD-7, traducción estándar Pfizer/Spitzer).
